...
- `opengraph-image.jpg` y `twitter-image.jpg` son las imágenes sociales
  estáticas del Lab para previews de Open Graph y X/Twitter; sus `.alt.txt`
  hermanos definen el texto alternativo.
